@testset "controlled sources" begin
    ...
    @circuit VoltageGainStage() begin
        ...
        E1 = voltage_controlled_voltage_source(input, gnd, output, gnd; gain = 3.0)
    end
    ...
    @circuit CurrentControlledStages() begin
        ...
        F1 = current_controlled_current_source(Vsense, current_output, gnd; gain = 2.0)
    ...
    add!(invalid_builder, current_controlled_current_source(controller, output, reference; gain = 2.0); name = :Fbad)
