...
@circuit DifferentialPair(; tail_current = 1mA, collector_resistance = 5.6kΩ) begin
    ...
    Vplus = voltage_source(inp, gnd; dc = 1.2V, ac = 0.5V); Vminus = voltage_source(inn, gnd; dc = 1.2V, ac = -0.5V)
    ...
    pair = matched_group(:input_pair; sigma_vbe = 300μV, sigma_log_beta = 0.03, correlation = 0.2)
