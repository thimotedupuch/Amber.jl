...
@circuit PrecisionBridge(; resistance = 1kΩ, strain = 500.0e-6, gain_resistance = 1kΩ) begin
    ...
    Rbridge1 = resistor(excitation, bridge_positive; value = resistance * (1 + strain), tolerance = 0.001)
    ...
    Rfeedback1 = resistor(first_output, first_feedback; value = 10kΩ, tolerance = 0.0001)
    Rfeedback2 = resistor(second_output, second_feedback; value = 10kΩ, tolerance = 0.0001)
    Rgain = resistor(first_feedback, second_feedback; value = gain_resistance, tolerance = 0.0001)
