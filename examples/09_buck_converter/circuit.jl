...
@circuit BuckConverter(;input_voltage=12V,switching_frequency=250kHz,duty_cycle=.42,
        inductance=47μH,capacitance=100μF,load=10Ω) begin
    ...
    Catch=diode(gnd,switching;model=JunctionDiode(saturation_current=20nA,
