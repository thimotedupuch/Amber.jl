...
const CMOS_NMOS=Level1MOSFET(threshold_voltage=.7V,
...
const CMOS_PMOS=Level1MOSFET(threshold_voltage=.7V,
    transconductance=1mA/V^2,channel_length_modulation=.03/V,
    body_effect=.35sqrt(V),surface_potential=.35V,
    gate_source_capacitance=8pF,gate_drain_capacitance=2pF)

@circuit CMOSInverter(;supply_voltage=5V,input_voltage=0V,waveform=nothing,
