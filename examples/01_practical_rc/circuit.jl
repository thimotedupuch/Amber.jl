...
@circuit PracticalLowPass(;R=10kΩ,C=10nF) begin
    ...
    R1=resistor(vin,vout;value=R,material=ThinFilm(tc1=15e-6/K,voltage_coefficient=.05e-6/V,excess_noise=true),package=SMD0603(series_inductance=.6nH,parallel_capacitance=40fF))
