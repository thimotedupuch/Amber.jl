...
For common tasks, jump to [op-amp wiring and noise measurement](#op-amp-voltage-follower-and-noise-measurement)
or [rectifier startup, ripple, and device warnings](#rectifier-startup-and-smoothing-capacitor-ripple).
