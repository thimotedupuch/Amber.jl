...
<!-- ![One unity-gain Sallen-Key low-pass section used by the hierarchical filter](../assets/circuits/sallen-key.svg) -->
...
```@example hierarchical_filter
@circuit HierarchicalActiveFilter(;
    R1=10kΩ,
    C1=10nF,
    R2=15kΩ,
    C2=6.8nF,
