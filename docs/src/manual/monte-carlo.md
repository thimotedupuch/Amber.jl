...
Variations include `Gaussian`, `LogNormal`, and bounded `UniformVariation`, plus shared `ProcessVariation`, covariance-driven `CorrelatedVariation`, and `MatchedGroup`. Component parameter paths connect them to named circuit elements.
